...
{
  var cubby=document.getElementById("the_end_text").style.display="block"
...
render() {
    ...
    return (<div style={{position:"relative"}}>
      <div className="dark" style={{display:disp, top:"0px", height: this.state.y===0? this.state.y:this.state.y-40, width: cam1.width}}>
        </div>
        <div className="dark" style={{display:disp,left:"0px", width: this.state.x===0? this.state.x:this.state.x-40, height:cam1.height}}>
        </div>
        <div className="dark" style={{display:disp, top: this.state.y+60, height: cam1.height-(this.state.y+60), width: cam1.width}}>
        </div>
        <div className="dark" style={{ display:disp,left:this.state.x+60, width: cam1.width-(this.state.x+60), height: cam1.height}}>
        </div>
